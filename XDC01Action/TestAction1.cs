...
namespace XDC01Action1
{
    public class TestAction1
    {
        ...
        public List<TestItem> PCBAVoltageTest(RelaySerial relaySerial, TDMSerial tDMVolSerial,
            System.Windows.Forms.DataGridView dataGridView, int rowIndex,  Logger logger, TestSpecMax testSpecMax, TestSpecMin testSpecMin, TestParam testParam)
        {
            try
            {
        ...
        public TestItem PCBAWorkCurrentTest(TDMSerial tDMCurSerial,
            System.Windows.Forms.DataGridView dataGridView, int rowIndex, Logger logger, TestSpecMax testSpecMax, TestSpecMin testSpecMin)
        {
            try
            {
        ...
        public List<TestItem> CheckRNandTagname(XDC01Serial xDC01Serial,
            System.Windows.Forms.DataGridView dataGridView, int rowIndex, Logger logger, TestParam testParam, TestStandard testStandard)
        {
            try
            {
        ...
        /// <returns></returns>
        public TestItem CheckWiFi(XDC01Serial xDC01Serial, System.Windows.Forms.DataGridView dataGridView, int rowIndex, Logger logger, 
        ...
        /// <param name="logger"></param>
        /// <returns></returns>
        public TestItem CheckMicrophone(XDC01Serial xDC01Serial, System.Windows.Forms.DataGridView dataGridView, int rowIndex, Logger logger,
        ...
        public TestItem CheckAudioManual(XDC01Serial xDC01Serial,
            System.Windows.Forms.DataGridView dataGridView, int rowIndex, Logger logger, TestParam testParam)
        {
            try
            {
        ...
        public List<TestItem> CheckDUTInfo(XDC01Serial xDC01Serial,
            System.Windows.Forms.DataGridView dataGridView, int rowIndex, Logger logger, TestSpecMax testSpecMax, TestSpecMin testSpecMin, TestStandard testStandard)
        {
            try
            {
        ...
        /// <returns></returns>
        public TestItem ApplySNandUIDFromCloud(CloudLoginForm cloudLoginForm, System.Windows.Forms.DataGridView dataGridView, int rowIndex, Logger logger, CloudModel cloudModel)
        {
            try
            {
                int start_time = Environment.TickCount;
        ...
        /// <param name="cloudModel"></param>
        /// <returns></returns>
        public TestItem CheckSNandUIDFromCloud(CloudLoginForm cloudLoginForm, System.Windows.Forms.DataGridView dataGridView, int rowIndex, Logger logger, CloudModel cloudModel)
        {
            try
            {
                int start_time = Environment.TickCount;
        ...
        /// <param name="cloudModel"></param>
        /// <returns></returns>
        public List<TestItem> PrintSnMAC(System.Windows.Forms.DataGridView dataGridView, int rowIndex, Logger logger, TestParam testParam, CloudModel cloudModel)
        {
            try
            {
                List<TestItem> testItems = new List<TestItem>();
