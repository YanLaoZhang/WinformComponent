...
namespace XDC01Action
{
    public class Printer
    {
        ...
        /// <returns></returns>
        public static bool Print_MAC(Logger logger, string printerName, string str_print_mac, string mac_count, ref string str_error_log)
        {
            try
            {
                // 打印第一张
        ...
        public static bool Print_SN(Logger logger, string printerName, string str_print_sn, string sn_count, ref string str_error_log)
        {
            try
            {
                // 打印第一张
